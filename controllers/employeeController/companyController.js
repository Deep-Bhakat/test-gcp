...
exports.getCompanyMaster = catchAsyncErrors( async (req, res, next) => {
    ...
    res.render('employee/company_master_tab',{
        message:'',
        companies,
        permissions
    });
...
exports.getCompanyMasterEdit = catchAsyncErrors( async (req, res, next) => {
    ...
    res.render('employee/company_master_edit',{
        message:'',
        company,
        permissions
    });
...
exports.getCompanyMasterView = catchAsyncErrors( async (req, res, next) => {
    ...
    console.log(company.company_name);
    res.render('employee/company_master_view',{
        message:'',
        company,
        permissions
    });
...
exports.getCompanyMasterViewDocuments = catchAsyncErrors(async( req,res,next) =>{
    ...
    res.render('employee/view_company_documents',{
        files:documents,
        permissions
    })
});
exports.getClientMaster = catchAsyncErrors( async (req, res, next) => {
    ...
    res.render('employee/employeer_master_tab',{
        message:'',
        companies,
        clients,
        permissions
...
exports.getClientEdit = catchAsyncErrors( async (req, res, next) => {
    ...
    res.render('employee/employer_master_edit',{
        message:'',
        companies,
        oldClient,
        permissions
...
exports.getClientMasterView = catchAsyncErrors( async (req, res, next) => {
    ...
    res.render('employee/client_master_view',{
        message:'',
        oldClient,
        permissions
    });
...
exports.getClientMasterViewDocuments = catchAsyncErrors(async( req,res,next) =>{
    ...
    res.render('employee/view_client_documents',{
        files:documents,
        permissions
    })
});
